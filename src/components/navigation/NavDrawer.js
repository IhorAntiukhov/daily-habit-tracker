...
function NavDrawer() {
  ...
  const navDrawerClass = classNames(
    'relative', 'z-10', 'inline-flex', 'flex-col', 'space-y-2', 'h-screen', 'pt-[4.5rem]', 'pl-4', 'pr-6',
  ...
  const darkeningAreaClass = classNames(
    'absolute', 'top-0', 'left-0', 'h-screen', 'w-screen', 'bg-[rgba(0,_0,_0,_0.6)]',
  ...
  return (
    <>
      <Icon icon={
        <IoReorderThreeOutline className="absolute z-20 top-4 left-4 w-10 h-10" onClick={() => setIsOpen(!isOpen)} />
